class Frame < ActiveRecord::Base
  ...
  has_attached_file :image, processors: [ :thumbnail, :transparency ], styles: {
    ...
    preview_0: '400x400>',
    preview_90: { geometry: '400x400>', convert_options: '-rotate 90' },
    preview_180: { geometry: '400x400>', convert_options: '-rotate 180' },
    preview_270: { geometry: '400x400>', convert_options: '-rotate 270' },
    thumbnail: '64x64>'
  }
